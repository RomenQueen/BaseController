...
public class PingYingUtil {
    ...
    public static String getSpells(String chs) {
...
//        return buffer.toString();
    ...
    // 词组解析
    public static String getAllSell(String chs) {
        String key, value;
        StringBuilder buffer = new StringBuilder();
        for (int i = 0; i < chs.length(); i++) {
            key = chs.substring(i, i + 1);
    ...
    public static String getFirstLetter(String str) {
        ...
        try {
            return String.valueOf(buffer.toString().charAt(0)).toUpperCase();
        } catch (Exception e) {
            return "#";
        }
    }
    ...
    public static void main(String[] args) {
        System.out.println(getAllSell("燚"));
    }
